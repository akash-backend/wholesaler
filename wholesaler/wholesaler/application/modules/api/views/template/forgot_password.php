...
<tr>
  <td>     
    <table class="content" align="center" cellpadding="0" cellspacing="0" border="0" style="border: 1px solid #ddd">
      <tr>
        <td bgcolor="#238de9 " class="header">
          <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td height="70" style="padding:20px;">
                <img class="fix" src="<?= base_url('assets/images/logo.png'); ?>" width="200" height="auto" style="margin: 0 auto;display: block;" border="0" alt="" />
              </td>
            </tr>
          </table>
      ...
      <tr>
        ...
        <h2 style="text-align: left; padding: 15px"><strong> Password change warning</strong></h2>
  ...
  <td>     
    <table class="content" align="center" cellpadding="0" cellspacing="0" border="0" style="border: 1px solid #ddd">
      ...
      <tr>
        ...
        <center><div align="center"><img src="<?= base_url('assets/images/thankyou.png'); ?>" class="img-responsive"></div> <p></p>
        <h2 style="text-align: left; padding: 15px"><strong> Your account has been created successfully and is ready to use </strong></h2>
