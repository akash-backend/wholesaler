...
.top-arrow {padding-top: 8px; padding-left: 8px;}
...
.loading_question:not(:required):after {
  content: '';
  display: block;
  font-size: 10px;
  width: 1em;
...
.loading.s:after {content:''; display:none;}
        ...
        echo '<body style="text-align:center;" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
         ...
         echo '<div class="loading">
            <br></div>' . "\n";
        echo '<div class="loading s" style="top:110px; left:-10px; width:400px">Please wait while redirecting...';
